...
<div class="block content">
	...
	<form method="post" action="?step=settings&lang=<?php echo $lang ?>">
		...
		<label class="alone" for="base_url">your base url is:<?= BASEURL ?></label><br>
		<label class="alone" for="admin_email">Set your company default admin_email:</label>
		<input name="admin_email" id="admin_email" type="text" class="inputtext w200" value="<?php echo 'admin@admin.com' ?>"></input>
