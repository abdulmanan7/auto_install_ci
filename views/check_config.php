...
<div class="block content">
	...
	<h2 class="heading info"><?php echo lang('title_system_check') ?></h2>
	...
	<h2 class="heading info"><?php echo lang('title_folder_check') ?></h2>
	...
	<h2 class="heading info"><?php echo lang('title_files_check') ?></h2>
