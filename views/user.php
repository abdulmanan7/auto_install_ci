...
<div class="block content">
	...
	<form method="post" action="?step=user&lang=<?php echo $lang ?>">
		...
		<dl>
			<dt>
				<label for="site_name"><?php echo lang('company_hostname')?></label>
			</dt>
			<dd>
				<input name="site_name" id="site_name" type="text" class="inputtext" value="Example.com"></input>
			</dd>
		</dl>
		...
		<dl>
			...
			<dd>
				<input name="first_name" id="firstname" type="text" class="inputtext" value="<?php echo isset($first_name)? $first_name:'' ?>"></input>
			</dd>
		</dl>
		...
		<dl>
			...
			<dd>
				<input name="last_name" id="lastname" type="text" class="inputtext" value="<?php echo isset($last_name)? $last_name:'' ?>"></input>
			</dd>
		</dl>
		...
		<div class="buttons">
			...
			<?php if ( !empty($skip)) :?>
				<button type="button" class="button info left" onclick="javascript:location.href='?step=finish&lang=<?php echo $lang ?>';"><?php echo lang('button_skip_next_step') ?></button>
			<?php endif ;?>
		</div>
	</form>
</div>